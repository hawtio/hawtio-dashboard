 ...
 */
module Dashboard {
  _module.controller("Dashboard.ImportController", ["$scope", "$location", "$routeParams", "dashboardRepository", ($scope, $location, $routeParams, dashboardRepository:DashboardRepository) => {
    ...
    $scope.importJSON = () => {
      ...
      try {
        ...
        //HawtioCore.notification("error", "Could not parse the JSON\n" + e);
        json = [];
      }
      var array = [];
