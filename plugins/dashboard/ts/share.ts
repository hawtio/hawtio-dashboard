 ...
 */
module Dashboard {
  export var ShareController = _module.controller("Dashboard.ShareController", ["$scope", "$location", "$routeParams", "dashboardRepository", ($scope, $location, $routeParams, dashboardRepository:DashboardRepository) => {
